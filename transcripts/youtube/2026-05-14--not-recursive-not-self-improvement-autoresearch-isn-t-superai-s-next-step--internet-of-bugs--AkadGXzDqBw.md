...
relevance_spans: [{"category": "agent-operations", "timestamp": "3:55", "phrase": "agents", "text": "A lot of people say that coding agents like Cloud Code can write code better than humans."}]
