...
- [ ] Run the full audit, push, and verify live GitHub/CI only when authorized.

## YouTube decisions and blockers

- Count only sources passing automated naming, metadata, timestamp, hash, relevance, quarantine, and rights checks.
- Preserve raw caption/ASR evidence separately from canonical accepted records.
